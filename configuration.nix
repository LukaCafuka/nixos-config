...

{
  ...
  networking.hostName = "vege"; # Define your hostname.
  ...
  systemd.services.nginx.serviceConfig.ReadOnlyPaths= [ "/mnt/nas-share-luka/multimedia/ostalo/content-warning-game" ];
